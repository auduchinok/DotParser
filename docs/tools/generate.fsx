...
let website = "/DotParser"

let githubLink = "http://github.com/auduchinok/DotParser"

// Specify more information about your project
let info =
  [ "project-name", "DotParser"
    "project-author", "Eugene Auduchinok"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/DotParser" ]
